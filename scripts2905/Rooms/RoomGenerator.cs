...
public class RoomGenerator : MonoBehaviour
{
    ...
    public int roomSpawnChance = 2; // Шанс на спавн комнаты, по умолчанию 2 - 50%, 3 - 66%...
    public int corridorMode = 0;
    ...
    void Start()
    {
        SpawnRoom(new Vector2(46, 50), startRoom, 4, 0, 0);
    }
        ...
        for (int i = 0; i <= 3; i = i + 1)
        {
            ...
            switch (i)
            {
                case 0:
                    ...
                    if ((((Random.Range(0, 101)) <= roomSpawnChance) || (spawnType == 2)) || (randRoom == 0))
                    {
                ...
                case 1:
                    ...
                    if (((Random.Range(0, 101) <= roomSpawnChance) || (spawnType == 3)) || (randRoom == 1))
                    {
                ...
                case 2:
                    ...
                    if ((((Random.Range(0, 101)) <= roomSpawnChance) || (spawnType == 0)) || (randRoom == 2))
                    {
                ...
                case 3:
                    ...
                    if ((((Random.Range(0, 101)) <= roomSpawnChance) || (spawnType == 1)) || (randRoom == 3))
                    {
        ...
        for (int i = 0; i <= vectors.Length - 1; i++)
        {
            ...
            if (vectors[i] != vr_vector)
            {
                if (roomCounter <= roomLimit)
                {
                    ...
                    {
                        vert = vertLocal;
                        if (SpawnCorridor(vectors[i], publicCorridorsVertical[Random.Range(0, publicCorridorsVertical.Count)], i, vert, hor, corridorMode) == false) {
                            switch (i)
                            {
                                case 0:
                    ...
                    {
                        hor = horLocal;
                        if (SpawnCorridor(vectors[i], publicCorridorsHorizontal[Random.Range(0, publicCorridorsHorizontal.Count)], i, vert, hor, corridorMode) == false) {
    ...
    bool SpawnCorridor(Vector3 position, GameObject corridor, int spawnType, int farFromSpawnVert = 0, int farFromSpawnHor = 0, int mode = 0)
        // mode = 0 - рандомные коридоры, mode = 1 - фиксированные коридоры
    {
        ...
        switch (spawnType)
        {
            case 0:
                ...
                if (((Random.Range(0, 2) == 1) || (spawnType == 2)) && (mode == 0))
                {
            ...
            case 1:
                ...
                if (((Random.Range(0, 2) == 1) || (spawnType == 3)) && (mode == 0))
                {
                    Debug.Log("спауню еще коридор");
            ...
            case 2:
                ...
                if (((Random.Range(0, 2) == 1) || (spawnType == 0)) && (mode == 0))
                {
                    Debug.Log("спауню еще коридор");
            ...
            case 3:
                ...
                if (((Random.Range(0, 2) == 1) || (spawnType == 1)) && (mode == 0))
                {
                    Debug.Log("спауню еще коридор");

...
public class RoomGeneratorGold : MonoBehaviour
{
    ...
    bool SpawnRoom(Vector3 position, GameObject room, int spawnType, int farFromSpawnVer, int farFromSpawnHor)
    {
        ...
        {
            if (AllowToSpawn(spawned_room, spawned_rooms[i]) == false || roomCounter >= roomLimit)
            {
        ...
        for (int i = 0; i <= 3; i = i + 1)
        {
            switch (i)
            {
                case 0:
                    ...
                    if (((Random.Range(0, 3) != 0) || (spawnType == 2)))
                    {
                ...
                case 1:
                    ...
                    if (((Random.Range(0, roomSpawnChance) != 0) || (spawnType == 3)))
                    {
                ...
                case 2:
                    ...
                    if (((Random.Range(0, roomSpawnChance) != 0) || (spawnType == 0)))
                    {
                ...
                case 3:
                    ...
                    if (((Random.Range(0, roomSpawnChance) != 0) || (spawnType == 1)))
                    {
